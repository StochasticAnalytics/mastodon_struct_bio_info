...
This privacy policy describes how cryoem.social ("cryoem.social", "we", "us") collects, protects and uses the personally identifiable information you may provide through the cryoem.social website or its API. The policy also describes the choices available to you regarding our use of your personal information and how you can access and update this information. This policy does not apply to the practices of companies that cryoem.social does not own or control, or to individuals that cryoem.social does not employ or manage.
